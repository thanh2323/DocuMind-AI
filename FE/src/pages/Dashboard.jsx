          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="flex flex-col gap-2 rounded-xl p-6 border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/50">
              <div className="flex items-center justify-between">
                <p className="text-base font-medium leading-normal text-slate-600 dark:text-gray-400">
                  Total Documents
                </p>
              ...
              <div className="flex gap-4 items-center mt-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-slate-700 dark:text-gray-300">
                    Ready: {statistics?.statusCounts?.Ready || 0}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="size-2 rounded-full bg-yellow-500"></div>
                  <span className="text-sm font-medium text-slate-700 dark:text-gray-300">
                    Pending: {statistics?.statusCounts?.Pending || 0}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="size-2 rounded-full bg-red-500"></div>
                  <span className="text-sm font-medium text-slate-700 dark:text-gray-300">
                    Error: {statistics?.statusCounts?.Error || 0}
                  </span>
                </div>
              </div>
            </div>
                  ...
                  {/* <div className="w-full md:w-auto md:max-w-xs">
                    <label className="flex flex-col w-full">
                      <div className="flex w-full flex-1 items-stretch rounded-lg h-11">
                        ...
                        <input
                          className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-slate-900 dark:text-white focus:outline-0 focus:ring-2 focus:ring-primary/50 border-none bg-gray-100 dark:bg-gray-800 h-full placeholder:text-slate-500 dark:placeholder:text-gray-500 px-4 rounded-l-none border-l-0 pl-2 text-sm font-normal leading-normal"
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead className="bg-gray-50 dark:bg-gray-900 border-b border-t border-gray-200 dark:border-gray-800">
                    <tr>
                      <th
                        className="px-6 py-3 text-xs font-semibold text-slate-600 dark:text-gray-400 uppercase tracking-wider"
                        scope="col"
                      >
                        Document Name
                      </th>
                      ...
                      <th
                        className="px-6 py-3 text-xs font-semibold text-slate-600 dark:text-gray-400 uppercase tracking-wider hidden md:table-cell"
                        scope="col"
                      >
                        Creation Date
                      </th>
                      <th
                        className="px-6 py-3 text-xs font-semibold text-slate-600 dark:text-gray-400 uppercase tracking-wider text-right"
                        scope="col"
                      ></th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                    {documents &&
                      documents.map((doc) => (
                        ...
                        >
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-800 dark:text-gray-200">
                            {doc.fileName}
                          </td>
                    ...
                    recentChats.map((chat) => (
                      ...
                      >
                        <div className="flex flex-col">
                          <a
                            className="text-sm font-medium text-slate-800 dark:text-gray-200 hover:text-primary dark:hover:text-primary/90 transition-colors"
                            href="#"
                          >
                            {chat.title}
                          </a>
